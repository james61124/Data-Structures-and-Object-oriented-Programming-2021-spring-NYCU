...
void MY_SYSTEM_APP::handle_key01(){
	switch(mSystemType){
		case SYSTEM_TYPE_MONTE_CARLO_SIMULATION:
			mMonteCarloSystem.mFunctionType=1;
			mMonteCarloSystem.reset();
			break;
		case SYSTEM_TYPE_GALAXY_SYSTEM:
			break;
...
void MY_SYSTEM_APP::handle_key02(){
	switch(mSystemType){
		case SYSTEM_TYPE_MONTE_CARLO_SIMULATION:
			mMonteCarloSystem.mFunctionType=2;
			mMonteCarloSystem.reset();
			break;
		case SYSTEM_TYPE_GALAXY_SYSTEM:
			break;
...
void MY_SYSTEM_APP::handle_key03(){
	switch(mSystemType){
		case SYSTEM_TYPE_MONTE_CARLO_SIMULATION:
			mMonteCarloSystem.mFunctionType=3;
			mMonteCarloSystem.reset();
			break;
		case SYSTEM_TYPE_GALAXY_SYSTEM:
			break;
...
void MY_SYSTEM_APP::handle_key04(){
	switch(mSystemType){
		case SYSTEM_TYPE_MONTE_CARLO_SIMULATION:
			mMonteCarloSystem.mFunctionType=4;
			mMonteCarloSystem.reset();
			break;
		case SYSTEM_TYPE_GALAXY_SYSTEM:
			break;
...
bool MY_SYSTEM_APP::handleKeyEvent( unsigned char key )
{
    ...
    case 'M':
        showMenu( );
		if ( mSystemType == SYSTEM_TYPE_MONTE_CARLO_SIMULATION ) {
            mMonteCarloSystem.minNumSamples();
			mMonteCarloSystem.reset();
        }
        break;
    case 's':
	...
	case ',':
		if ( mSystemType == SYSTEM_TYPE_MONTE_CARLO_SIMULATION ) {
            mMonteCarloSystem.decreaseNumSamples();
			mMonteCarloSystem.reset();
        }
        break;
	case '.':
		if ( mSystemType == SYSTEM_TYPE_MONTE_CARLO_SIMULATION ) {
            mMonteCarloSystem.increaseNumSamples();
			mMonteCarloSystem.reset();
        }
        break;
	case '/':
		if ( mSystemType == SYSTEM_TYPE_MONTE_CARLO_SIMULATION ) {
            mMonteCarloSystem.maxNumSamples();
			mMonteCarloSystem.reset();
        }
        break;
