...
void CAMERA::printf( ) const
{
    cout << "CAMERA::mTranslationXYZ:" << mTranslationXYZ.x << "\t" << mTranslationXYZ.y << "\t" << mTranslationXYZ.z << endl;

    cout << "CAMERA::mZoomFactor:" << mZoomFactor << endl;
}
